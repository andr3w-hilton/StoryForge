...
Process docs, specs, and adventure TODOs.

## Process

| File | Purpose |
|------|---------|
| [EXPANSION_GUIDE.md](EXPANSION_GUIDE.md) | Full guide for expanding or writing adventures — read this first |
| [original_plan.md](original_plan.md) | Original StoryForge build plan (historical) |

## Adventure Specs

| File | Adventure |
|------|-----------|
| [the_hollow_forest_spec.md](the_hollow_forest_spec.md) | The Hollow Forest — full flag/ending/act spec |
...
|-----------|----------|---------|-------|--------|
| [The Hollow Forest](the_hollow_forest_spec.md) | 267 | 5V / 1D | 13 ok, 0 unchecked | Done — v1.0 |
